<?php $page="0";  $ver="1";  $lang="pl";  $tree=":";  $INCLUDE_PATH="include";  $MAIN_INCLUDE_PATH="include";  $PAGE_PATH="php";  $IMAGES="images/1";  $UIMAGES="images";  $UFILES="att";  $SERVER_ID="11"; include("include/pre.php");?><?php include("include/action.php");?>
...
<head>
	...
	<meta name="generator" content="WebKameleon 5.02">
	<meta name="WebKameleonId" content="server=11; page=0; ver=1; lang=pl" />

	<meta name="ftpdate" content="Thu, 25 Aug 2011 22:34:57 +0200" />
...
<div class="body_h">
  ...
  <div class="title"><h2>Logowanie {if:info}{info}{endif:info} <img src=images/1/szablon/dot.png></h2></div>
  <div  class="txt"><form method="post" style="padding: 20px;" action="promienko/" id="kameleon_form_sid_4240" name="kameleon_form_1">
