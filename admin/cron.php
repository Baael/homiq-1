<?php $page="15";  $ver="1";  $lang="pl";  $tree=":0:100:13:";  $INCLUDE_PATH="include";  $MAIN_INCLUDE_PATH="include";  $PAGE_PATH="php";  $IMAGES="images/1";  $UIMAGES="images";  $UFILES="att";  $SERVER_ID="11";  $prevpage="crons.php";  $pagetype=1; include("include/pre.php");?><?php include("include/action.php");?>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" lang="pl" xml:lang="pl">
<html>
<head>
	<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
	<title>Pozycja kalendarza</title>
	<meta name="Robots" content="all">
	<meta name="generator" content="WebKameleon 5.06">
	<meta name="WebKameleonId" content="server=11; page=15; ver=1; lang=pl" />
...
<body    ><div class="body_h">
  ...
  <div class="body_menu">
  	<div class="szukaj"><?php parse_str("more=cron.php&cos=&next=cron.php&size=&class=&costxt=&title=&pagetype=1&self=cron.php&tree=:0:100:13:&sid=4226&prevpage=crons.php&INCLUDE_PATH=include&html=js.php"); 
...
<li ><a href="promienko/pobor-energii/">Pobór energii</a></li>
  ...
  <div class="title"><h2>Kalendarz <img src=images/1/szablon/dot.png></h2></div>
  <div  class="txt"><form method="post" action="crons.php" id="kameleon_form_sid_4224" name="kameleon_form_1">
