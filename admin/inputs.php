<?php $page="3";  $ver="1";  $lang="pl";  $tree=":0:100:";  $INCLUDE_PATH="include";  $MAIN_INCLUDE_PATH="include";  $PAGE_PATH="php";  $IMAGES="images/1";  $UIMAGES="images";  $UFILES="att";  $SERVER_ID="11";  $prevpage="promienko/";  $pagetype=1; include("include/pre.php");?><?php include("include/action.php");?>
...
<head>
	...
	<meta name="WebKameleonId" content="server=11; page=3; ver=1; lang=pl" />
...
<body    ><div class="body_h">
  ...
  <div class="body_menu">
  	<div class="szukaj"><?php parse_str("more=inputs.php&cos=&next=inputs.php&size=&class=&costxt=&title=&pagetype=1&self=inputs.php&tree=:0:100:&sid=4226&prevpage=promienko%2F&INCLUDE_PATH=include&html=js.php"); 
...
<li ><a href="promienko/pobor-energii/">Pobór energii</a></li>
  ...
  <div class="title"><h2>Wejścia <img src=images/1/szablon/dot.png></h2></div>
...
<table border="1" cellpadding="4" cellspacing="0" class="tabela_1">
	...
	<tbody>
<!-- loop:sql_table --><!-- if:i_active -->		<tr>
			<td>
				<a href="{next}{sign}i_id={i_id}&amp;{sql_table_link}">{lp}</a></td>
			<td>
				<a href="{next}{sign}i_id={i_id}&amp;{sql_table_link}">{i_name}</a></td>
			<td>
				<a href="{next}{sign}i_id={i_id}&amp;{sql_table_link}">{i_master}-<strong>{i_module}</strong>-{i_adr}</a></td>
			<td>
				<a href="{next}{sign}i_id={i_id}&amp;{sql_table_link}">{c}</a></td>
			<td>
				<a href="{self}{sign}action=IM.0&amp;i_id={i_id}&amp;{sql_table_link}">{i_type}</a></td>
			<td>
				<a href="{next}{sign}i_id={i_id}&amp;{sql_table_link}">{i_state}</a></td>
			<td>
				<a href="{self}{sign}action=delete&amp;table=inputs,i_id&amp;i_id={i_id}&amp;{sql_table_link}" onclick="return confirm('na pewno?')"><img alt="Usuń" border="0" src="images/trash.gif" /></a></td>
		</tr>
<!-- endif:i_active --><!-- if:!i_active -->		<tr disabled="disabled">
			<td>
				<a href="{next}{sign}i_id={i_id}&amp;{sql_table_link}">{lp}</a></td>
			<td>
				<a href="{next}{sign}i_id={i_id}&amp;{sql_table_link}">{i_name}</a></td>
...
<!-- endif:!i_active --><!-- endloop:sql_table -->	</tbody>
</table><?php parse_str("more=inputs.php&cos=&next=input.php&size=100&class=&costxt=YTo3OntzOjM6InNpZCI7czo0OiI0MjA5IjtzOjQ6ImV2YWwiO3M6MTAzOiJpZiAoIXN0cmxlbigk%0D%0AX1JFUVVFU1Rbb3JkZXJieV0pKSANCnsNCiAgICRfUkVRVUVTVFtvcmRlcmJ5XT0naV9uYW1lJzsN%0D%0ACiAgICRfUkVRVUVTVFtvcmRlcmhvd109J0FTQyc7DQp9IjtzOjM6InNxbCI7czoxMDI6IlNFTEVD%0D%0AVCAqIEZST00gaW5wdXRzDQokc3FsX2ZpbHRyX3doZXJlICRzcWxfZmlsdHIgDQpPUkRFUiBCWSAk%0D%0AX1JFUVVFU1Rbb3JkZXJieV0gJF9SRVFVRVNUW29yZGVyaG93XSANCiI7czo1OiJjb3VudCI7czo2%0D%0AMzoiU0VMRUNUIGNvdW50KGlfaWQpIEZST00gaW5wdXRzIA0KJHNxbF9maWx0cl93aGVyZSAkc3Fs%0D%0AX2ZpbHRyIA0KIjtzOjk6Imxvb3BfZXZhbCI7czoxOTI6IiRzcWw9IlNFTEVDVCBjb3VudCgqKSBB%0D%0AUyBjIEZST00gYWN0aW9uIFdIRVJFIGFfaW5wdXRfbWFzdGVyPSckdGFiW2lfbWFzdGVyXScgQU5E%0D%0AIGFfaW5wdXRfbW9kdWxlPSckdGFiW2lfbW9kdWxlXScgQU5EIGFfaW5wdXRfYWRyPSIucG93KDIs%0D%0AJHRhYltpX2Fkcl0pOw0KcGFyc2Vfc3RyKHF1ZXJ5MnVybCgkc3FsKSk7DQokdGFiW2NdPSRjOyI7%0D%0Aczo2OiJoZWFkZXIiO3M6MToiMSI7czo2OiJmaWx0cnkiO3M6MDoiIjt9&title=Wej%C5%9Bcia&pagetype=1&self=inputs.php&tree=:0:100:&sid=4209&prevpage=promienko%2F&INCLUDE_PATH=include&html=sql_table/sql_table.php"); 
