<?php $page="19";  $ver="1";  $lang="pl";  $tree=":0:100:8:";  $INCLUDE_PATH="../../include";  $MAIN_INCLUDE_PATH="../../include";  $PAGE_PATH="../../php";  $IMAGES="../../images/1";  $UIMAGES="../../images";  $UFILES="../../att";  $SERVER_ID="11";  $prevpage="../../macros.php";  $pagetype=1; include("../../include/pre.php");?><?php include("../../include/action.php");?>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" lang="pl" xml:lang="pl">
<html>
<head>
	<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
	<title>Makra w tle</title>
	<meta name="Robots" content="all">
	<meta name="generator" content="WebKameleon 5.06">
	<meta name="WebKameleonId" content="server=11; page=19; ver=1; lang=pl" />
...
<body    ><div class="body_h">
  ...
  <div class="body_menu">
  	<div class="szukaj"><?php parse_str("more=.&cos=&next=.&size=&class=&costxt=&title=&pagetype=1&self=.&tree=:0:100:8:&sid=4226&prevpage=..%2F..%2Fmacros.php&INCLUDE_PATH=../../include&html=js.php"); 
...
<li class="active"><a href="../../macros.php">Makra</a><ul><li ><a href="../makra/w-przyszlolci/">w przyszłości</a></li>
</ul></li>
...
<li ><a href="../pobor-energii/">Pobór energii</a></li>
  ...
  <div  class="txt"><p><p>{if:page=8}<a href=".">Makra w tle</a>{endif:page=8} {if:page=19}<a href="../../macros.php">Makra gł&oacute;wne</a>{endif:page=19}</p>
...
<p>&nbsp;</p>
<p><a href="{next}?m_active=1&amp;m_visible=1&amp;{sql_table_link}">Dodaj</a></p></p><?php parse_str("more=.&cos=&next=..%2F..%2Fmacro.php&size=120&class=&costxt=%3D&title=Makra&pagetype=1&self=.&tree=:0:100:8:&sid=5623&prevpage=..%2F..%2Fmacros.php&INCLUDE_PATH=../../include&html=sql_table/sql_table.php"); 
