<?php $page="18";  $ver="1";  $lang="pl";  $tree=":0:100:";  $INCLUDE_PATH="../../include";  $MAIN_INCLUDE_PATH="../../include";  $PAGE_PATH="../../php";  $IMAGES="../../images/1";  $UIMAGES="../../images";  $UFILES="../../att";  $SERVER_ID="11";  $prevpage="../";  $pagetype=1; include("../../include/pre.php");?><?php include("../../include/action.php");?>
...
<head>
	...
	<meta name="WebKameleonId" content="server=11; page=18; ver=1; lang=pl" />

	<meta name="ftpdate" content="Thu, 01 Dec 2011 07:15:12 +0100" />
...
<li ><a href="../pobor-energii/">Pobór energii</a></li>
  ...
  <div class="title"><h2>Zdarzenia <img src=../../images/1/szablon/dot.png></h2></div>
