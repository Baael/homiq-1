<?php $page="100";  $ver="1";  $lang="pl";  $tree=":0:";  $INCLUDE_PATH="../include";  $MAIN_INCLUDE_PATH="../include";  $PAGE_PATH="../php";  $IMAGES="../images/1";  $UIMAGES="../images";  $UFILES="../att";  $SERVER_ID="11";  $prevpage="../";  $pagetype=1; include("../include/pre.php");?><?php include("../include/action.php");?>
...
<head>
	...
	<meta name="WebKameleonId" content="server=11; page=100; ver=1; lang=pl" />
...
<body    ><div class="body_h">
  ...
  <div class="body_menu">
  	<div class="szukaj"><?php parse_str("more=.&cos=&next=.&size=&class=&costxt=&title=&pagetype=1&self=.&tree=:0:&sid=4226&INCLUDE_PATH=../include&html=js.php"); 
...
<li ><a href="pobor-energii/">Pobór energii</a></li>
  ...
  <div  class="txt"><p>{if:g_alarm}<img alt="" src="../images/alarm.png" style="width: 40px; height: 35px;" />{endif:g_alarm}{if:!g_empty}<img alt="" src="../images/fullhouse.png" style="width: 40px; height: 35px;" />{endif:!g_empty}{if:g_daylight}<img alt="" src="../images/dzien.png" style="width: 40px; height: 35px;" />{endif:g_daylight}{if:!g_daylight}<img alt="" src="../images/noc.png" style="width: 40px; height: 35px;" />{endif:!g_daylight}{if:!g_day}<img alt="" src="../images/sleep.png" style="width: 40px; height: 35px;" />{endif:!g_day}</p>
