<?php $page="21";  $ver="1";  $lang="pl";  $tree=":0:100:16:";  $INCLUDE_PATH="../../../include";  $MAIN_INCLUDE_PATH="../../../include";  $PAGE_PATH="../../../php";  $IMAGES="../../../images/1";  $UIMAGES="../../../images";  $UFILES="../../../att";  $SERVER_ID="11";  $prevpage="../../../temperatury.php";  $pagetype=1; include("../../../include/pre.php");?><?php include("../../../include/action.php");?>
...
<head>
	...
	<meta name="WebKameleonId" content="server=11; page=21; ver=1; lang=pl" />
...
<body    ><div class="body_h">
  ...
  <div class="body_menu">
  	<div class="szukaj"><?php parse_str("more=.&cos=&next=.&size=&class=&costxt=&title=&pagetype=1&self=.&tree=:0:100:16:&sid=4226&prevpage=..%2F..%2F..%2Ftemperatury.php&INCLUDE_PATH=../../../include&html=js.php"); 
...
<li class="active"><a href="../../../temperatury.php">Temperatury</a><ul><li class="active"><a href=".">Kotłownia</a></li>
</ul></li>
...
<li ><a href="../../pobor-energii/">Pobór energii</a></li>
      ...
      <div class="body_s_r">
    		...
    		<div class="box">
  <div class="title"><h2>Kotłownia <img src=../../../images/1/szablon/dot.png></h2></div>
  <div  class="txt box_szary"><p><img alt="" src=".?action=piec" /></p>
