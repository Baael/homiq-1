<?php $page="10";  $ver="1";  $lang="pl";  $tree=":0:100:";  $INCLUDE_PATH="../../include";  $MAIN_INCLUDE_PATH="../../include";  $PAGE_PATH="../../php";  $IMAGES="../../images/1";  $UIMAGES="../../images";  $UFILES="../../att";  $SERVER_ID="11";  $prevpage="../";  $pagetype=1; include("../../include/pre.php");?><?php include("../../include/action.php");?>
...
<head>
	...
	<meta name="WebKameleonId" content="server=11; page=10; ver=1; lang=pl" />
...
<li class="active"><a href=".">Akcje</a></li>
...
<li ><a href="../pobor-energii/">Pobór energii</a></li>
  ...
  <div class="title"><h2>Akcje <img src=../../images/1/szablon/dot.png></h2></div>
...
<table border="1" cellpadding="4" cellspacing="0" class="tabela_1">
	<thead>
		<tr>
			...
			<th id="a_name">
				Nazwa</th>
			<th id="a_input_module">
				Wejście</th>
			<th id="a_input_state" width="3%">
				IS</th>
			<th id="a_input_module_state" width="3%">
				OS</th>
			<th id="a_output_module">
				Wyjście</th>
			<th id="a_macro">
				Makro</th>
			<th id="a_sleep" width="3%">
				Czas</th>
			<th>
				Akcje</th>
		</tr>
	...
	<tbody>
<!-- loop:sql_table --><!-- if:a_active -->		<tr>
			<td>
				<a href="{next}{sign}a_id={a_id}&amp;{sql_table_link}">{lp}</a></td>
			<td>
				<a href="{next}{sign}a_id={a_id}&amp;{sql_table_link}">{a_name}</a></td>
			<td title="{we_title}">
				<a href="{next}{sign}a_id={a_id}&amp;{sql_table_link}">{a_input_master}-{a_input_module}: {adr}</a></td>
			<td>
				<a href="{next}{sign}a_id={a_id}&amp;{sql_table_link}">{a_input_state}</a></td>
			<td>
				<a href="{next}{sign}a_id={a_id}&amp;{sql_table_link}">{a_input_module_state}</a></td>
			<td title="{wy_title}">
				<a href="{next}{sign}a_id={a_id}&amp;{sql_table_link}">{a_output_master}-{a_output_module} {a_output_adr}</a></td>
			<td>
				<a href="{next}{sign}a_id={a_id}&amp;{sql_table_link}">{a_macro}</a></td>
			<td>
				<a href="{next}{sign}a_id={a_id}&amp;{sql_table_link}">{a_sleep}</a></td>
			<td>
				<a href="{self}{sign}action=delete&amp;table=action,a_id&amp;a_id={a_id}&amp;{sql_table_link}" onclick="return confirm('na pewno?')"><img alt="Usuń" border="0" src="../../images/trash.gif" /></a></td>
		</tr>
<!-- endif:a_active --><!-- if:!a_active -->		<tr disabled="disabled">
			<td>
				<a href="{next}{sign}a_id={a_id}&amp;{sql_table_link}">{lp}</a></td>
			<td>
				<a href="{next}{sign}a_id={a_id}&amp;{sql_table_link}">{a_name}</a></td>
...
<!-- endif:!a_active --><!-- endloop:sql_table -->	</tbody>
</table>
<p><a href="{next}?a_active=1&amp;{sql_table_link}">Dodaj</a></p>
<p><a href="../../link.php?{sql_table_link}"> </a></p>
