<?php $page="12";  $ver="1";  $lang="pl";  $tree=":0:100:10:";  $INCLUDE_PATH="../../include";  $MAIN_INCLUDE_PATH="../../include";  $PAGE_PATH="../../php";  $IMAGES="../../images/1";  $UIMAGES="../../images";  $UFILES="../../att";  $SERVER_ID="11";  $prevpage=".";  $pagetype=1; include("../../include/pre.php");?><?php include("../../include/action.php");?>
...
<head>
	...
	<meta name="WebKameleonId" content="server=11; page=12; ver=1; lang=pl" />
...
<body    ><div class="body_h">
  ...
  <div class="body_menu">
  	<div class="szukaj"><?php parse_str("more=akcja.php&cos=&next=akcja.php&size=&class=&costxt=&title=&pagetype=1&self=akcja.php&tree=:0:100:10:&sid=4226&prevpage=.&INCLUDE_PATH=../../include&html=js.php"); 
...
<li ><a href="../pobor-energii/">Pobór energii</a></li>
  ...
  <div  class="txt box_szary"><form method="post" action="." id="kameleon_form_sid_4221" name="kameleon_form_1">
...
setTimeout(ustawZaChwile,500);
 ...
 include("../../include/eval/eval.php");  ?>
  ...
  <div  class="txt"><?php parse_str("more=akcja.php&cos=&next=akcja.php&size=&class=&costxt=&title=&pagetype=1&self=akcja.php&tree=:0:100:10:&sid=4222&prevpage=.&INCLUDE_PATH=../../include&html=wewy-select.php"); 
