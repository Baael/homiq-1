<?php $page="8";  $ver="1";  $lang="pl";  $tree=":0:100:";  $INCLUDE_PATH="include";  $MAIN_INCLUDE_PATH="include";  $PAGE_PATH="php";  $IMAGES="images/1";  $UIMAGES="images";  $UFILES="att";  $SERVER_ID="11";  $prevpage="promienko/";  $pagetype=1; include("include/pre.php");?><?php include("include/action.php");?>
...
<head>
	...
	<meta name="WebKameleonId" content="server=11; page=8; ver=1; lang=pl" />

	<meta name="ftpdate" content="Sat, 12 Nov 2011 13:30:25 +0100" />
...
<body    ><div class="body_h">
  ...
  <div class="body_menu">
  	<div class="szukaj"><?php parse_str("more=macros.php&cos=&next=macros.php&size=&class=&costxt=&title=&pagetype=1&self=macros.php&tree=:0:100:&sid=4226&prevpage=promienko%2F&INCLUDE_PATH=include&html=js.php"); 
...
<li ><a href="promienko/pobor-energii/">Pobór energii</a></li>
  ...
  <div  class="txt"><p>{if:page=8}<a href="promienko/makra-w-tle/">Makra w tle</a>{endif:page=8} {if:page=19}<a href="macros.php">Makra gł&oacute;wne</a>{endif:page=19}</p>
