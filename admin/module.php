<?php $page="7";  $ver="1";  $lang="pl";  $tree=":0:100:2:";  $INCLUDE_PATH="include";  $MAIN_INCLUDE_PATH="include";  $PAGE_PATH="php";  $IMAGES="images/1";  $UIMAGES="images";  $UFILES="att";  $SERVER_ID="11";  $prevpage="modules.php";  $pagetype=1; include("include/pre.php");?><?php include("include/action.php");?>
...
<head>
	...
	<meta name="WebKameleonId" content="server=11; page=7; ver=1; lang=pl" />
...
<body    ><div class="body_h">
  ...
  <div class="body_menu">
  	<div class="szukaj"><?php parse_str("more=module.php&cos=&next=module.php&size=&class=&costxt=&title=&pagetype=1&self=module.php&tree=:0:100:2:&sid=4226&prevpage=modules.php&INCLUDE_PATH=include&html=js.php"); 
...
<li ><a href="promienko/pobor-energii/">Pobór energii</a></li>
  ...
  <div class="title"><h2>Moduł <img src=images/1/szablon/dot.png></h2></div>
  <div  class="txt box_szary"><form method="post" action="modules.php" id="kameleon_form_sid_4208" name="kameleon_form_1">
