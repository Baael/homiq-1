<?php $page="9";  $ver="1";  $lang="pl";  $tree=":0:100:4:";  $INCLUDE_PATH="include";  $MAIN_INCLUDE_PATH="include";  $PAGE_PATH="php";  $IMAGES="images/1";  $UIMAGES="images";  $UFILES="att";  $SERVER_ID="11";  $prevpage="outputs.php";  $pagetype=1; include("include/pre.php");?><?php include("include/action.php");?>
...
<head>
	...
	<meta name="WebKameleonId" content="server=11; page=9; ver=1; lang=pl" />
...
<body    ><div class="body_h">
  ...
  <div class="body_menu">
  	<div class="szukaj"><?php parse_str("more=output.php&cos=&next=output.php&size=&class=&costxt=&title=&pagetype=1&self=output.php&tree=:0:100:4:&sid=4226&prevpage=outputs.php&INCLUDE_PATH=include&html=js.php"); 
...
<li ><a href="promienko/pobor-energii/">Pobór energii</a></li>
  ...
  <div class="title"><h2>Wyjście <img src=images/1/szablon/dot.png></h2></div>
  <div  class="txt"><form method="post" action="outputs.php" id="kameleon_form_sid_4212" name="kameleon_form_1">
	<p><input name="action" type="hidden" value="update" /> <input name="outputs[o_id]" type="hidden" value="{o_id}" /> {sql_table_form}</p>
		...
		<tbody>
			<tr>
				<td>
					Nazwa:</td>
				<td>
					<input name="outputs[o_name]" size="30" type="text" value="{o_name}" /></td>
			</tr>
			<tr>
				<td>
					Symbol:</td>
				<td>
					<input name="outputs[o_symbol]" size="6" type="text" value="{o_symbol}" /></td>
			</tr>
			<tr>
				<td>
					Master:</td>
				<td>
					<select name="outputs[o_master]" onchange="location.href='{REQUEST_URI}{amp}master='+this.value"><option selected="selected">Wybierz</option><!-- masters --></select></td>
			</tr>
<!-- if:modules -->			<tr>
				<td>
					Moduł:</td>
				<td>
					<select name="outputs[o_module]"><option selected="selected">Wybierz</option><!-- modules --></select></td>
			</tr>
<!-- endif:modules -->			<tr>
				<td>
					Adres:</td>
				<td>
					<input maxlength="2" name="outputs[o_adr]" size="2" type="text" value="{o_adr}" /></td>
			</tr>
			<tr>
				<td>
					Typ:</td>
				<td>
					<input maxlength="2" name="outputs[o_type]" size="2" type="text" value="{o_type}" /></td>
			</tr>
			<tr>
				<td>
					Czas włączenia:</td>
				<td>
					<input maxlength="5" name="outputs[o_sleep]" size="5" type="text" value="{o_sleep}" /> sek.</td>
			</tr>
			<tr>
				<td>
					Grupa:</td>
				<td>
					<input name="outputs[o_group]" size="30" type="text" value="{o_group}" /></td>
			</tr>
			<tr>
				<td>
					Aktywne:</td>
				<td>
					<input name="outputs[o_active]" type="hidden" value="0" /> {if:o_active}<input checked="checked" name="outputs[o_active]" type="checkbox" value="1" />{endif:o_active}{if:!o_active}<input name="outputs[o_active]" type="checkbox" value="1" />{endif:!o_active}</td>
			</tr>
		</tbody>
	</table>
	<p><input class="button" type="submit" value="Zapisz" /></p>
</form>
<p>&nbsp;</p><?php parse_str("more=output.php&cos=&next=outputs.php&size=&class=&costxt=base64%3AYToyOntzOjM6InNpZCI7czo0OiI0MjEyIjtzOjM6InBocCI7czo1NzY6InBhcnNlX3N0cihxdWVy%0D%0AeTJ1cmwoIlNFTEVDVCAqIEZST00gb3V0cHV0cyBXSEVSRSBvX2lkPSIuKDArJF9HRVRbJ29faWQn%0D%0AXSkpKTsNCg0KJG9fc2xlZXArPTA7DQoNCmlmICghJF9HRVRbJ29faWQnXSkgJF9SRVFVRVNUWydL%0D%0AQU1FTEVPTl9PQl9UT0tFTl9CTEFOSyddPTE7DQppbmNsdWRlKCIkSU5DTFVERV9QQVRIL3NxbF90%0D%0AYWJsZS9zcWxfdGFibGVfaGlkZGVuLnBocCIpOw0KDQppZiAoJF9SRVFVRVNUWydtYXN0ZXInXSkg%0D%0AJG9fbWFzdGVyPSRfUkVRVUVTVFsnbWFzdGVyJ107DQokX1JFUVVFU1RbJ21hc3RlcnMnXT1vcHRp%0D%0Ab25zKCdtYXN0ZXJzJywibV9jaWQgfHwgJyAtICcgfHwgbV9uYW1lIiwnbV9jaWQnLCRvX21hc3Rl%0D%0Acik7DQokX1JFUVVFU1RbJ2FtcCddPScmJzsNCiRfUkVRVUVTVFsnbW9kdWxlcyddPScnOw0KaWYg%0D%0AKHN0cmxlbigkb19tYXN0ZXIpKSANCiAgICRfUkVRVUVTVFsnbW9kdWxlcyddPW9wdGlvbnMoJ21v%0D%0AZHVsZXMnLCJtX25hbWUgfHwgJyAtICcgfHwgbV9zeW1ib2wiLCdtX2FkcicsJG9fbW9kdWxlLCcn%0D%0ALCJtX3R5cGUgSU4gKCdJJywnTycpIEFORCBtX21hc3Rlcj0nJG9fbWFzdGVyJyIpOyI7fQ%3D%3D&title=Wyj%C5%9Bcie&pagetype=1&self=output.php&tree=:0:100:4:&sid=4212&prevpage=outputs.php&INCLUDE_PATH=include&html=eval/eval.php"); 
