<?php $page="1";  $ver="1";  $lang="pl";  $tree=":0:100:";  $INCLUDE_PATH="include";  $MAIN_INCLUDE_PATH="include";  $PAGE_PATH="php";  $IMAGES="images/1";  $UIMAGES="images";  $UFILES="att";  $SERVER_ID="11";  $prevpage="promienko/";  $pagetype=1; include("include/pre.php");?><?php include("include/action.php");?>
...
<head>
	...
	<meta name="WebKameleonId" content="server=11; page=1; ver=1; lang=pl" />
...
<body    ><div class="body_h">
  ...
  <div class="body_menu">
  	<div class="szukaj"><?php parse_str("more=masters.php&cos=&next=masters.php&size=&class=&costxt=&title=&pagetype=1&self=masters.php&tree=:0:100:&sid=4226&prevpage=promienko%2F&INCLUDE_PATH=include&html=js.php"); 
...
<li ><a href="promienko/pobor-energii/">Pobór energii</a></li>
  ...
  <div class="title"><h2>Urządzenia typu MASTER <img src=images/1/szablon/dot.png></h2></div>
  <div  class="txt box_szary"><p>
<table class="tabela_1" border="1" cellspacing="0" cellpadding="4">
    <tbody>
<!-- loop:sql_table -->
        <!-- if:m_active -->
        <tr>
            <td><a href="{next}?m_id={m_id}">{lp}</a></td>
            <td><a href="{next}?m_id={m_id}">{m_name}</a></td>
            <td><a href="{next}?m_id={m_id}">{m_cid}</a></td>
            <td><a href="{next}?m_id={m_id}">{m_ip}:{m_port}</a></td>
        </tr>
...
<p>&nbsp;</p>
<p><a href="{next}?m_active=1">Dodaj</a></p><?php parse_str("more=masters.php&cos=&next=master.php&size=&class=box_szary&costxt=YTo1OntzOjM6InNpZCI7czo0OiI0MjAzIjtzOjQ6ImV2YWwiO3M6MDoiIjtzOjM6InNxbCI7czoy%0D%0AMToiU0VMRUNUICogRlJPTSBtYXN0ZXJzIjtzOjk6Imxvb3BfZXZhbCI7czowOiIiO3M6NjoiZmls%0D%0AdHJ5IjtzOjA6IiI7fQ%3D%3D&title=Urz%C4%85dzenia+typu+MASTER&pagetype=1&self=masters.php&tree=:0:100:&sid=4203&prevpage=promienko%2F&INCLUDE_PATH=include&html=sql_table/sql_table.php"); 
