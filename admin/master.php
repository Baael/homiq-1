<?php $page="6";  $ver="1";  $lang="pl";  $tree=":0:100:1:";  $INCLUDE_PATH="include";  $MAIN_INCLUDE_PATH="include";  $PAGE_PATH="php";  $IMAGES="images/1";  $UIMAGES="images";  $UFILES="att";  $SERVER_ID="11";  $prevpage="masters.php";  $pagetype=1; include("include/pre.php");?><?php include("include/action.php");?>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" lang="pl" xml:lang="pl">
<html>
<head>
	<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
	<title>Urządzenie</title>
	<meta name="Robots" content="all">
	<meta name="generator" content="WebKameleon 5.06">
	<meta name="WebKameleonId" content="server=11; page=6; ver=1; lang=pl" />
...
<body    ><div class="body_h">
  ...
  <div class="body_menu">
  	<div class="szukaj"><?php parse_str("more=master.php&cos=&next=master.php&size=&class=&costxt=&title=&pagetype=1&self=master.php&tree=:0:100:1:&sid=4226&prevpage=masters.php&INCLUDE_PATH=include&html=js.php"); 
...
<li class="active"><a href="masters.php">Urządzenia</a></li>
...
<li ><a href="promienko/pobor-energii/">Pobór energii</a></li>
  ...
  <div class="title"><h2>Urządzenie <img src=images/1/szablon/dot.png></h2></div>
  <div  class="txt box_szary"><form method="post" action="masters.php" id="kameleon_form_sid_4205" name="kameleon_form_1">
    <p><input type="hidden" name="action" value="update" /> <input type="hidden" name="masters[m_id]" value="{m_id}" />
    <table class="tabela_1" border="1" cellspacing="0" cellpadding="4">
        <tbody>
            <tr>
                <td>Nazwa:</td>
                <td><input size="30" name="masters[m_name]" value="{m_name}" type="text" /></td>
            </tr>
            <tr>
                <td>Symbol:</td>
                <td><input maxlength="2" size="3" name="masters[m_cid]" value="{m_cid}" type="text" /></td>
            </tr>
            <tr>
                <td>Host + port:</td>
                <td><input maxlength="15" size="15" name="masters[m_ip]" value="{m_ip}" type="text" />:<input maxlength="5" size="5" name="masters[m_port]" value="{m_port}" type="text" /></td>
            </tr>
            <tr>
                <td>Aktywne:</td>
                <td><input type="hidden" name="masters[m_active]" value="0" /> {if:m_active}<input checked="checked" type="checkbox" name="masters[m_active]" value="1" />{endif:m_active}{if:!m_active}<input type="checkbox" name="masters[m_active]" value="1" />{endif:!m_active}</td>
            </tr>
        </tbody>
    </table>
    </p>
    <p><input class="button" type="submit" value="Zapisz" /></p>
</form><?php parse_str("more=master.php&cos=&next=masters.php&size=&class=box_szary&costxt=base64%3AYToyOntzOjM6InNpZCI7czo0OiI0MjA1IjtzOjM6InBocCI7czoxMzk6InBhcnNlX3N0cihxdWVy%0D%0AeTJ1cmwoIlNFTEVDVCAqIEZST00gbWFzdGVycyBXSEVSRSBtX2lkPSIuKDArJF9HRVRbJ21faWQn%0D%0AXSkpKTsNCg0KaWYgKCEkX0dFVFsnbV9pZCddKSAkX1JFUVVFU1RbJ0tBTUVMRU9OX09CX1RPS0VO%0D%0AX0JMQU5LJ109MTsiO30%3D&title=Urz%C4%85dzenie&pagetype=1&self=master.php&tree=:0:100:1:&sid=4205&prevpage=masters.php&INCLUDE_PATH=include&html=eval/eval.php"); 
