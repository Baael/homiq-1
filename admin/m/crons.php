<?php $page="13";  $ver="5";  $lang="pl";  $tree=":0:100:";  $INCLUDE_PATH="../include";  $MAIN_INCLUDE_PATH="../include";  $PAGE_PATH="php";  $IMAGES="../images/5";  $UIMAGES="../images";  $UFILES="../att";  $SERVER_ID="11";  $prevpage="promienko/";  $pagetype=1; include("../include/pre.php");?><?php include("../include/action.php");?><!DOCTYPE html 
     PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"
     "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" lang="pl">
<head>
	<title>Promienko - Kalendarz</title>
	...
	<meta name="CMSWebKameleon" content="server=11; page=13; ver=5; lang=pl" />
...
<tr>
	<td class="left">
		...
		<?php parse_str("more=crons.php&cos=&next=crons.php&size=&class=&costxt=&title=&pagetype=1&self=crons.php&tree=:0:100:&sid=4226&prevpage=promienko%2F&INCLUDE_PATH=../include&html=js.php"); 
...
<tr>
	<td class="left">
		...
		Kalendarze<table border="1" cellpadding="4" cellspacing="0" class="tabela_1">
	<thead>
		<tr>
			<th id="c_id" width="5%">
				Lp</th>
