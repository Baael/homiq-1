<?php $page="3";  $ver="5";  $lang="pl";  $tree=":0:100:";  $INCLUDE_PATH="../include";  $MAIN_INCLUDE_PATH="../include";  $PAGE_PATH="php";  $IMAGES="../images/5";  $UIMAGES="../images";  $UFILES="../att";  $SERVER_ID="11";  $prevpage="promienko/";  $pagetype=1; include("../include/pre.php");?><?php include("../include/action.php");?><!DOCTYPE html 
     PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"
     "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" lang="pl">
<head>
	<title>Promienko - Wejścia</title>
	...
	<meta name="CMSWebKameleon" content="server=11; page=3; ver=5; lang=pl" />
...
<tr>
	<td class="left">
		...
		<?php parse_str("more=inputs.php&cos=&next=inputs.php&size=&class=&costxt=&title=&pagetype=1&self=inputs.php&tree=:0:100:&sid=4226&prevpage=promienko%2F&INCLUDE_PATH=../include&html=js.php"); 
...
<tr>
	<td class="left">
		...
		Wejścia<p>{loop:navi}Pozycji: <strong>{ile}</strong>, strony: <a href="javascript:sql_table_navi_{sid}({first})">pierwsza</a> {loop:strony} <a class="navi{active}" href="javascript:sql_table_navi_{sid}({strona})">{text}</a> {endloop:strony} <a href="javascript:sql_table_navi_{sid}({last})">ostatnia</a>{endloop:navi}</p>
