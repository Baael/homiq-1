<?php $page="17";  $ver="5";  $lang="pl";  $tree=":0:100:8:";  $INCLUDE_PATH="../../../../include";  $MAIN_INCLUDE_PATH="../../../../include";  $PAGE_PATH="../../../php";  $IMAGES="../../../../images/5";  $UIMAGES="../../../../images";  $UFILES="../../../../att";  $SERVER_ID="11";  $prevpage="../../../macros.php";  $pagetype=1; include("../../../../include/pre.php");?><?php include("../../../../include/action.php");?><!DOCTYPE html 
     PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"
     "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" lang="pl">
<head>
	<title>Promienko - w przyszłości</title>
	...
	<meta name="CMSWebKameleon" content="server=11; page=17; ver=5; lang=pl" />
...
<tr>
	<td class="left">
		...
		<?php parse_str("more=.&cos=&next=.&size=&class=&costxt=&title=&pagetype=1&self=.&tree=:0:100:8:&sid=4226&prevpage=..%2F..%2F..%2Fmacros.php&INCLUDE_PATH=../../../../include&html=js.php"); 
