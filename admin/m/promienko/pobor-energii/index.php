<?php $page="26";  $ver="5";  $lang="pl";  $tree=":0:100:";  $INCLUDE_PATH="../../../include";  $MAIN_INCLUDE_PATH="../../../include";  $PAGE_PATH="../../php";  $IMAGES="../../../images/5";  $UIMAGES="../../../images";  $UFILES="../../../att";  $SERVER_ID="11";  $prevpage="../";  $pagetype=1; include("../../../include/pre.php");?><?php include("../../../include/action.php");?><!DOCTYPE html 
     PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"
     "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" lang="pl">
<head>
	<title>Promienko - Pobór energii</title>
	...
	<meta name="CMSWebKameleon" content="server=11; page=26; ver=5; lang=pl" />
...
<tr>
	<td class="left">
    		...
    		<div class="pl"  class="std1" style="width:748px;">
		Zużycie energii w ciągu doby<p><script language="javascript">
...
if (AC_FL_RunContent == 0 || DetectFlashVer == 0) {
	...
	if(hasRightVersion) { 
		AC_FL_RunContent(
			...
			'FlashVars', 'library_path=../../../include/charts/charts_library&xml_source=..%2F..%2F..%2Finclude%2Fpower.php'+chartXmlAdd(), 
			'id', 'my_chart',
			'name', 'my_chart',
			'menu', 'true',
...
</div> <?php ob_start(); ?><div class="pl"  class="std1" style="">
