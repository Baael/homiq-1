<?php $page="0";  $ver="5";  $lang="pl";  $tree=":";  $INCLUDE_PATH="../include";  $MAIN_INCLUDE_PATH="../include";  $PAGE_PATH="php";  $IMAGES="../images/5";  $UIMAGES="../images";  $UFILES="../att";  $SERVER_ID="11"; include("../include/pre.php");?><?php include("../include/action.php");?><!DOCTYPE html 
...
<head>
	...
	<meta name="CMSWebKameleon" content="server=11; page=0; ver=5; lang=pl" />
	<meta name="copyright" content="Pudel w Poznaniu 2011" />
	<meta name="ftpdate" content="Thu, 25 Aug 2011 22:19:56 +0200" />
...
<style type="text/css"> 
	...
	td.left table {width:230px;}
	ul {padding-left:20px; margin:2px;}
	li { padding: 0 2px 2px 0; font-weight:bold;}
	blockquote a {color:#000000;  text-decoration:none; }
	h1 {width: 230px; font-size:11px;}
	.std2 { width:230px;}
	.intext { display: block }
	.sbt {margin-top: 10px}
</style>
</head>
<body>  
...
<script type="text/javascript">
	...
	km_infos["ajax_link"]='/kameleon/ajax.php';
	km_infos["page"]='0';
</script>

<table width="100%" class="width">
<tbody>
	<tr>
    	<td>
