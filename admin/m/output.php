<?php $page="9";  $ver="5";  $lang="pl";  $tree=":0:100:4:";  $INCLUDE_PATH="../include";  $MAIN_INCLUDE_PATH="../include";  $PAGE_PATH="php";  $IMAGES="../images/5";  $UIMAGES="../images";  $UFILES="../att";  $SERVER_ID="11";  $prevpage="outputs.php";  $pagetype=1; include("../include/pre.php");?><?php include("../include/action.php");?><!DOCTYPE html 
     PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"
     "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" lang="pl">
<head>
	<title>Promienko - Wyjście</title>
	...
	<meta name="CMSWebKameleon" content="server=11; page=9; ver=5; lang=pl" />
...
<tr>
	<td class="left">
		...
		<?php parse_str("more=output.php&cos=&next=output.php&size=&class=&costxt=&title=&pagetype=1&self=output.php&tree=:0:100:4:&sid=4226&prevpage=outputs.php&INCLUDE_PATH=../include&html=js.php"); 
...
<tr>
	<td class="left">
		...
		Wyjście<form method="post" action="outputs.php" id="kameleon_form_sid_4212" name="kameleon_form_1">
