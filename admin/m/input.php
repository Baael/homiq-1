<?php $page="5";  $ver="5";  $lang="pl";  $tree=":0:100:3:";  $INCLUDE_PATH="../include";  $MAIN_INCLUDE_PATH="../include";  $PAGE_PATH="php";  $IMAGES="../images/5";  $UIMAGES="../images";  $UFILES="../att";  $SERVER_ID="11";  $prevpage="inputs.php";  $pagetype=1; include("../include/pre.php");?><?php include("../include/action.php");?><!DOCTYPE html 
     PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"
     "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" lang="pl">
<head>
	<title>Promienko - Wejście</title>
	...
	<meta name="CMSWebKameleon" content="server=11; page=5; ver=5; lang=pl" />
	<meta name="copyright" content="Pudel w Poznaniu 2011" />
	<meta name="ftpdate" content="Mon, 21 Nov 2011 18:06:07 +0100" />
...
<tr>
	<td class="left">
		...
		<?php parse_str("more=input.php&cos=&next=input.php&size=&class=&costxt=&title=&pagetype=1&self=input.php&tree=:0:100:3:&sid=4226&prevpage=inputs.php&INCLUDE_PATH=../include&html=js.php"); 
...
<tr>
	<td class="left">
		...
		Wejście<form method="post" action="inputs.php" id="kameleon_form_sid_4210" name="kameleon_form_1">
